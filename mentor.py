...
class Mentor(Person):
    def __init__(
                 self, first_name, last_name, year_of_birth, gender,
                 coffee, energy, nickname, involvment, irritation, sweets
                 ):
        Person.__init__(
                        self, first_name, last_name,
                        year_of_birth, gender, coffee, energy
                        )
        ...
        try:
            with open('data/mentors.csv') as mentor_file:
                ...
                for mentor in all_mentors:
                    mentors = Mentor(mentor[0], mentor[1], mentor[2],
                                     mentor[3], mentor[4], mentor[5],
                                     mentor[6], mentor[7], mentor[8], mentor[9])
